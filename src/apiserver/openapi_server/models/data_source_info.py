...
class DataSourceInfo(Model):
    ...
    """
    def __init__(self, source_id: str=None, source_type: int=None, time_registration: int=None, time_last_update: int=None, source_timezone: int=None, source_stratum_level: int=None, source_location_info: SourceLocationInfo=None):  # noqa: E501
    ...
    @source_type.setter
    def source_type(self, source_type: int):
